...
function setup()
 {
  ...
  pendulum1 = new Pendulum(340, 450, 100);
  pendulum2 = new Pendulum(400, 450, 100);
  pendulum3 = new Pendulum(460, 450, 100);
  pendulum4 = new Pendulum(520, 450, 100);
  pendulum5 = new Pendulum(580, 450, 100);
